...
export async function subSite(sub){
    ...
    const subsubNavigation = el('ul', {class:"subNavigation"});
    ...
    const footerElement = el('footer', {}, el('p', {},indexJson.footer));
    footerElement.appendChild(el('img',{src:"./img/graffitti.png"}))
